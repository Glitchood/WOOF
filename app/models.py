...
class User(SQLModel, table=True):
    ...
    transactions_received: List["Transaction"] = Relationship(back_populates="receiver", sa_relationship_kwargs={"foreign_keys": "Transaction.to_user_id"})
...
class Transaction(SQLModel, table=True):
    ...
    receiver: User = Relationship(back_populates="transactions_received", sa_relationship_kwargs={"foreign_keys": "Transaction.to_user_id"})
